        ...
        <Center py={6}>
          ...
          >
            ...
            <Text textAlign={"center"}>
              Project Manager, Full-Stack Developer, Team Leader, Architect
            </Text>
            <a
      ...
      <Flex direction="row" justifyContent="center">
        ...
        <Center py={6}>
          ...
          >
            ...
            <Text textAlign={"center"}>Landing page, UX designer</Text>
            <a
        ...
        >
          ...
          >
            <IconButton
              mt={3}
              icon={
                <Image src={`${process.env.PUBLIC_URL}/github.png`} width={5} />
              }
              aria-label="GitHub"
            ></IconButton>
          </a>
